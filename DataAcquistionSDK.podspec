#
#  Be sure to run `pod spec lint DataAcquistionSDK.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "wangshuai" => "13304526341@163.com" }
  # Or just: spec.author    = "158962809@qq.com"
  # spec.authors            = { "wangshuai" => "13304526341@163.com" }
  # spec.social_media_url   = "https://twitter.com/shuai.wang40@pactera.com"
  ...
  spec.source       = { :git => "https://github.com/bushedezhuizhu/DataAcquisitionSDK.git", :tag => "#{spec.version}" }
